...
const STATE_STYLES: Record<ProjectState, string> = {
  PROPOSAL: "bg-slate-500/15 text-slate-600 dark:text-slate-400 border-slate-500/30",
  SCOPING: "bg-blue-500/15 text-blue-600 dark:text-blue-400 border-blue-500/30",
